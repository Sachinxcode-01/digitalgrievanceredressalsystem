...
import { 
  ...
  MapPin, X, Plus, AlertCircle, ArrowLeft, Paperclip, ClipboardList
} from 'lucide-react';
...
export const SubmitGrievancePage = ({ user }) => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      // Clean up draft
      localStorage.removeItem('resolvenow_resolvenow_grievance_draft');
      localStorage.removeItem('resolvenow_grievance_draft');
      
      toast.success(`Grievance submitted successfully. Ticket ID: ${ticketId}`);
      navigate('/grievances');
    } catch (err) {
      toast.error(`Filing failed: ${err.message}`);
    } finally {
